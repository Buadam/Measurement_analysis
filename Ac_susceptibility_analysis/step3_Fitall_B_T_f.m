...
Savefolder='Fitted_Cole_Cole_best';
s=1; %save images?
s2=1; %save functions and parameters
...
for t=7:13
    ...
    fits_CC_cycsky{t}=fit_susc_B_T(fr{t},all,dmdhc{t},t,Branges,dB,Chi_blcorr,Chi_baseline{t},blcorr(t),logtau(t),s,Savefolder,cl,s2,functionfolder1);
    cl=0;
    s=2;
    Branges=[Bt1(t),Bt2(t),B12(t),B22(t)];
    fits_CC_skyfm{t}=fit_susc_B_T(fr{t},all,dmdhc{t},t,Branges,dB,Chi_blcorr,Chi_baseline{t},blcorr(t),logtau(t),s,Savefolder,cl,s2,functionfolder1);
end    
